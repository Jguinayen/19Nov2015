        ...
        <table>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="TXTBXCUSTOMID0" runat="server"></asp:TextBox>
                </td>
                <td class="auto-style6">Date</td>
                <td class="auto-style15">
                    <asp:TextBox ID="TXTBXDATEREG0" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style3">&nbsp;</td>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="TXTBXPETID0" runat="server"></asp:TextBox>
                </td>
                <td class="auto-style6">Breed</td>
                <td class="auto-style15">
                    <asp:DropDownList ID="DRPBREED0" runat="server">
            ...
            <tr>
                ...
                <td class="auto-style9">
                    <asp:TextBox ID="TXTBXPETNAME0" runat="server" Width="205px"></asp:TextBox>
                </td>
                <td class="auto-style10">Hairtype</td>
                <td class="auto-style11">
                    <asp:DropDownList ID="DRPHAIRTYPE0" runat="server">
                        <asp:ListItem>-Please Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:DropDownList ID="DRPTYPE0" runat="server" OnSelectedIndexChanged="DRPTYPE_SelectedIndexChanged">
                        <asp:ListItem>Please Select</asp:ListItem>
                ...
                <td class="auto-style2">
                    <asp:DropDownList ID="DRPWEIGHT0" runat="server">
                        <asp:ListItem>-Please Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="TXTBXOTHERS0" runat="server"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style4">
                    <asp:TextBox ID="TXTBXPRECAUTION0" runat="server" Height="50px" TextMode="MultiLine" Width="280px"></asp:TextBox>
                </td>
                <td class="auto-style6">Coat Condition</td>
                <td class="auto-style2">
                    <asp:DropDownList ID="DRPCOAT0" runat="server">
                        <asp:ListItem>-Please Select-</asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style3" colspan="3">
                    <asp:Button ID="BTNSAVE0" runat="server" OnClick="BTNSAVE_Click" Text="Add Pet" Width="154px" />
                    &nbsp;<asp:Button ID="BTNCANCEL0" runat="server" Text="Cancel" Width="113px" />
                    <br />
                    <br />
                    <br />
                </td>
